	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("fsi", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "contacts" ] = array( "url" => "contacts", "type" => 0 );
	$projectEntitiesReverse[ "contacts" ] = "contacts";
	$projectEntities[ "fsi" ] = array( "url" => "fsi", "type" => 0 );
